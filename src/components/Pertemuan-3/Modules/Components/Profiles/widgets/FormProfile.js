        ...
        (successSubmit) ? <Navigate to="/home" replace={true} /> : (
            <div style={{marginTop:'7rem'}} className='card '>
                <div className="card-header">
                    <h3 style={{justifyContent:'center', textAlign:'center'}} className="card-title align-items-start flex-column">
                ...
                <div className="card-body">
                    <form className='form-profile' method='post' onSubmit={(e) => handlerSubmit(e)} id="form-profile" >
                        ...
                        <div className="text-center">
                            <button style={{width:'7rem', backgroundColor:'maroon', marginTop:'10px'}} type="button" className='btn btn-lg btn-light'>Clear</button>
                            <button style={{width:'7rem', backgroundColor:'blue', marginTop:'10px'}} type="submit" className='btn btn-lg btn-primary mx-2 btn-submit'>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
